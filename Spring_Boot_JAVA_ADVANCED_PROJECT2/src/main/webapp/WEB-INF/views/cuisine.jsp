				...
				<table class="table table-bordered">
					...
					<c:forEach var="cuisine" items="${cuisines}">
						<tr>
							...
							<a href="/admin/cuisine/update/${cuisine.id }" class="btn btn-outline-danger btn-sm">Update</a> 
							<a href="/admin/cuisine/delete/${cuisine.id }" class="btn btn-outline-warning btn-sm">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</table>
